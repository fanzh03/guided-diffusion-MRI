...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, x_3T, model_kwargs=None, noise=None):
        """
        ...
        device = x_t.device  # 获取 x_t 的设备
        x_3T = x_3T.to(device)  # 将 x_3T 移动到与 x_t 相同的设备
        x_t_cat = th.cat((x_t, x_3T), dim=1)
        terms = {}
